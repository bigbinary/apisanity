...
ActiveRecord::Schema.define(version: 20170413132320) do
  ...
  create_table "api_assertions", id: :serial, force: :cascade do |t|
    t.string "key"
    t.string "value"
    t.string "comparison"
    t.string "kind"
  ...
  create_table "api_responses", id: :serial, force: :cascade do |t|
    t.string "url"
    t.string "method"
